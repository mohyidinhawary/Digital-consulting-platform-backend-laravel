...
public function GetMessagesOutgoing($id){
    ...
    $outgoing=DB::table('experts_messages')->where('expert_id',$id)->select('expert_id')->first();
    if(!$outgoing){
        return response()->json([
    ...
    return response()->json([
        ...
        public function GetMessages($id){
            ...
            $user_messages=DB::table('users_messages')->where('expert_id',$id)->select('expert_id')->first();
            if(!$user_messages){
                return response()->json([
